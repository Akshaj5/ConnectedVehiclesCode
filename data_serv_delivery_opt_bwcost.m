function [bw_cost,mem] = data_serv_delivery_opt_bwcost(ov_sets,len_of_sets,N,M,beta,bw_edge,mem_edge,mem_occup,mem_app,x,v2e_trvtime,vel_free,bandwidth,density_jam,density,bw_const,l_cov)
...
%     end
    ...
    subject to
        ...
        for i = 1:nov
            for j = 1:noe
                (mem(i,j)/(bw_edge*3600)) <= v2e_trvtime(i,j);
            end
        end
